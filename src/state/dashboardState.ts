...
export function mapLogs(response: CodexLogsResponse): DashboardLogRow[] {
...
export function mapPagination(response: CodexLogsResponse, isLoadingMore = false): DashboardPagination {
  const { page, page_size, total } = response.data;
